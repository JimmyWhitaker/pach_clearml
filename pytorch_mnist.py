...
def main():
    ...
    task = Task.init(project_name=pipeline_name, task_name='Pachyderm PyTorch MNIST Train')
    ...
    if (args.save_model):
        torch.save(model.state_dict(), os.path.join(args.save_location, "mnist_cnn.pt"))
